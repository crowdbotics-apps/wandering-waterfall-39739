...
## Project Structure
    ...
    ├── wandering_waterfall_39739  # Django project configurations
...
1. Clone this repo and `cd wandering_waterfall_39739`
...
2. Clone this repo and `cd wandering_waterfall_39739`
